<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="操作员" prop="operation">
        <el-input
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['parking:rechargerecord:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['parking:rechargerecord:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['parking:rechargerecord:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['parking:rechargerecord:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="rechargerecordList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作员" align="center" prop="operation" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="操作员" prop="operation">
          <el-input v-model="form.operation" placeholder="请输入操作员" />
        </el-form-item>
      </el-form>
...
<script>
import { listRechargerecord, getRechargerecord, delRechargerecord, addRechargerecord, updateRechargerecord } from "@/api/parking/rechargerecord";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除充值车操作记录编号为"' + ids + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('parking/rechargerecord/export', {
        ...this.queryParams
