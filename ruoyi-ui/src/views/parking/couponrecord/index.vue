...
<!--      <el-table-column label="使用状态" align="center" prop="state" >
        <template scope="scope">
          ...
          <span style="color: green" v-else-if="scope.row.state==2">已过期</span>
        </template>
      </el-table-column>-->
<!--      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
    ...
    <!--    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="优惠卷" prop="parkingcouponid">
          <el-input v-model="form.parkingcouponid" placeholder="请输入优惠卷" />
        </el-form-item>
        ...
        <el-form-item label="车牌" prop="license">
          <el-input v-model="form.license" placeholder="请输入车牌" />
        </el-form-item>
        ...
        <el-form-item label="使用状态0代表未使用1代表已使用" prop="state">
          <el-input v-model="form.state" placeholder="请输入使用状态0代表未使用1代表已使用" />
        </el-form-item>
      </el-form>
