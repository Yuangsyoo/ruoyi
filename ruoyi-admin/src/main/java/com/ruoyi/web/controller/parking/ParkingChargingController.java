...
public class ParkingChargingController extends BaseController
{
    ...
    @Anonymous
    public AjaxResult getInfo1(@RequestParam("parkingLotInformationId") Long parkingLotInformationId,@RequestParam("distinguish")Long distinguish) {
        ParkingCharging parkingCharging=parkingChargingService.getInfo1(parkingLotInformationId,distinguish);
        return AjaxResult.success(parkingCharging);
    }
    /**
     * 新增计费规则
     */
