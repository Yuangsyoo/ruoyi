 ...
 * 
 * 
 * @function CRC循环冗余校验工具类
 * @author Liangjw
 * @date 2021年3月30日上午9:26:45
 * @since JDK 1.8
 */
public class CRCUtil {
    ...
    public static void main(String[] args) {
        ...
        // 00 03 83 03 07 08 09 AA55016400010000C199AF
        //byte[] data = {0x01,0x64,0x00,0x26,0x00,0x0A,0x01,0x00,0x01,0x00,(byte)0xC1,(byte)0xD9,(byte)0xCA,(byte)0xB1,(byte)0xB3,(byte)0xB5,0x00,0x00};
        byte[] bytes2 = Hex.toByteArray("01640026000A01000100C1D9CAB1B3B50000");
        byte[] data = {0x01,0x64,0x00,0x26,0x00,0x0D,0x04,0x00,0x02,0x00,(byte)0xC7,(byte)0xEB,(byte)0xBD,(byte)0xC9,(byte)0xB7,(byte)0xD1,0x30,(byte)0xD4,(byte)0xAA,0x00,0x00};
        byte[] data2 = {0x01,0x64,0x00,0x26,0x00,0x0C,0x02,0x00,0x02,0x00,(byte)0xB4,(byte)0xA8,0x58,0x44,0x32,0x37,0x37,0x38,0x00,0x00};
        ...
        int crc = CRCUtil.calcCrc16(bytes2);
        System.out.println("低位在前，高位在后:" + String.format("0x%04x", crc));
        int res = CRCUtil.calcCrc16(data2);
