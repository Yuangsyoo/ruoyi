...
public class LPRDemo {
	...
	private void InitClient(){
		try{
			...
			int handle = lpr.VzLPRClient_Open("172.17.3.171", 80, "admin", "admin");
			...
			//lpr.VzLPRClient_SetIOOutputAuto(handle,0,500);
			SnapImg(handle);
	...
	private int SendSerialData(int serial_handle) {
		//byte data[] = new byte[]{(byte) 0xAA,0x55,0x00,0x64,0x00,0x22,0x00,0x09,(byte)0xb4,(byte)0xa8,0x47,0x39,0x41,0x46,0x33,0x32,0x0b,0x6e,0x50,(byte)0xAF};
		//AA5502640020000a020Ab4a84739414633320b47AF
		byte data[] = new byte[]{(byte) 0xAA,0x55,02,0x64,0x00,0x20,0x00,0x0a,0x02,0x0A,(byte)0xb4,(byte)0xa8,0x47,0x39,0x41,0x46,0x33,0x32,0x0b,0x47,(byte)0xAF};
